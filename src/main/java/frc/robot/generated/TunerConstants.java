...
public class TunerConstants {
  ...
  private static final Slot0Configs steerGains = new Slot0Configs()
      ...
      .withKP(163.96).withKI(0).withKD(0.5)
      .withKS(0.1033).withKV(2.609).withKA(0.04039)
      .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
  // When using closed-loop control, the drive motor uses the control
  // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
  private static final Slot0Configs driveGains = new Slot0Configs()
      // .withKP(0.15521).withKI(0).withKD(0)
      // 0.0018456)
      .withKP(0.01).withKI(0).withKD(0)
      .withKS(0.19536).withKV(0.11854).withKA(0.0017669);
  ...
  // 2.78
  private static final double kCoupleRatio = 2.78;

  private static final double kDriveGearRatio = 5.357142857142857;
  private static final double kSteerGearRatio = 21.428571428571427;
  public static final Distance kWheelRadius = Inches.of(1.918728097);
