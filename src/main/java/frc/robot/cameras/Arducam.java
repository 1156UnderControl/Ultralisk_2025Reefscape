...
import frc.Java_Is_UnderControl.Vision.Cameras.Types.PhotonVision.PhotonVisionCamera;

public class Arducam {
  ICameraOdometry camera = new PhotonVisionCamera("Arducam_OVN9281_USB_Camera",
      new Translation3d(0.826772, 14.404905, 14.25),
