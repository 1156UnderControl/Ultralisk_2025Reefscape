...
public class ArmSubsystem extends SubsystemBase implements IArm {
  ...
  private ArmSubsystem() {
    ...
    motorArm1.configureMotionProfiling(0.099957, 0.0, 0,
        ffArm.calculate(Units.degreesToRadians(this.positionTarget), this.velocityTarget), 200, 100, 0.01);
  ...
  public void go100Degrees() {
    motorArm1.setPositionReferenceMotionProfiling(this.positionTarget);
  }
