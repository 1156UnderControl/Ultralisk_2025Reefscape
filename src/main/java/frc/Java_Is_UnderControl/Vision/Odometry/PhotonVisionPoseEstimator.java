 ...
 * 
 * public PhotonVisionPoseEstimator(PhotonCamera camera, Transform3d
 * cameraPosition) {
 * this.camera = camera;
 * this.fieldAprilTagLayout =
 ...
 * this.photonPoseEstimator.setMultiTagFallbackStrategy(PoseStrategy.
 * LOWEST_AMBIGUITY);
 ...
 * 
 * public PhotonVisionPoseEstimator(PhotonCamera camera, Transform3d
 * cameraPosition, boolean only2TagsMeasurements) {
 ...
 * Optional<EstimatedRobotPose> photonPoseEstimation =
 * this.photonPoseEstimator.update();
 ...
 * convertPhotonPoseEstimation(photonPoseEstimation.get());
 ...
 * }
 * 
 * private PoseEstimation convertPhotonPoseEstimation(EstimatedRobotPose
