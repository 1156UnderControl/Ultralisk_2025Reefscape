 ...
 * 
 * public LimelightPoseEstimator(String limelightName, boolean
 * only2TagsMeasurements, boolean useMegaTag1,
 * double limitAngVelForUpdating) {
 ...
 * || Math.abs(OdometryEnabledSwerveSubsystem.robotAngularVelocity) >=
 * limitAngVelForUpdating) {
 ...
 * LimelightHelpers.getBotPoseEstimate_wpiBlue(this.limelightName);
 ...
 * }
 * 
 * private PoseEstimation convertPoseEstimate(PoseEstimate
 * limelightPoseEstimate) {
